...
# 5. Creates a second, independent tidy data set with the average of each variable for each activity and each subject. setwd('C:\Users\SPhythian\Desktop\Datasci_workfile\Cleaning_Getting_Data')

###### 1. Merge the training and the test sets to create one data set.
#Set working directory
setwd('C:/Users/SPhythian/Desktop/Datasci_workfile/Cleaning_Getting_Data/UCI HAR Dataset/UCI HAR Dataset')
